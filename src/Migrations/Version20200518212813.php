 ...
 */
final class Version20200518212813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO `afamanager_member` (`member_id`, `member_join_member_first_licence`, `member_join_member_last_licence`, `member_join_last_grade`, `member_join_member_modification`, `member_firstname`, `member_name`, `member_photo`, `member_sex`, `member_address`, `member_zip`, `member_city`, `member_country`, `member_email`, `member_birthday`, `member_comment`) VALUES (1, NULL, NULL, NULL, NULL, \'Frédéric\', \'Buchon\', \'nophoto.png\', 1, \'30\', \'7033\', \'Cuesmes\', \'BE\', \'kadrack@hotmail.com\', \'2020-05-01\', NULL)');
