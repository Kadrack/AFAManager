 ...
 */
final class Version20200517113959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE afamanager_club (club_id INT NOT NULL, club_join_club_last_history INT DEFAULT NULL, club_join_club_main_teacher INT DEFAULT NULL, club_name VARCHAR(255) NOT NULL, club_address VARCHAR(255) DEFAULT NULL, club_zip INT DEFAULT NULL, club_city VARCHAR(255) DEFAULT NULL, club_province INT DEFAULT NULL, club_creation DATE DEFAULT NULL, club_type INT DEFAULT NULL, club_bce_number VARCHAR(255) DEFAULT NULL, club_iban VARCHAR(255) DEFAULT NULL, club_url VARCHAR(255) DEFAULT NULL, club_email_public VARCHAR(255) DEFAULT NULL, club_president VARCHAR(255) DEFAULT NULL, club_treasurer VARCHAR(255) DEFAULT NULL, club_secretary VARCHAR(255) DEFAULT NULL, club_email_contact VARCHAR(255) DEFAULT NULL, club_comment LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_4E5E06CCBF36FF2B (club_join_club_last_history), UNIQUE INDEX UNIQ_4E5E06CCBABDBC14 (club_join_club_main_teacher), PRIMARY KEY(club_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE afamanager_member (member_id INT AUTO_INCREMENT NOT NULL, member_join_member_first_licence INT DEFAULT NULL, member_join_member_last_licence INT DEFAULT NULL, member_join_last_grade_dan INT DEFAULT NULL, member_join_last_kyu INT DEFAULT NULL, member_join_member_modification INT DEFAULT NULL, member_firstname VARCHAR(255) NOT NULL, member_name VARCHAR(255) NOT NULL, member_photo VARCHAR(255) NOT NULL, member_sex INT NOT NULL, member_address LONGTEXT NOT NULL, member_zip VARCHAR(255) DEFAULT NULL, member_city VARCHAR(255) NOT NULL, member_country VARCHAR(255) NOT NULL, member_email VARCHAR(255) DEFAULT NULL, member_birthday DATE NOT NULL, member_comment LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_CBC39255C8439838 (member_join_member_first_licence), UNIQUE INDEX UNIQ_CBC3925512EDE43A (member_join_member_last_licence), UNIQUE INDEX UNIQ_CBC3925588970AFD (member_join_last_grade_dan), UNIQUE INDEX UNIQ_CBC39255E94B142A (member_join_last_kyu), UNIQUE INDEX UNIQ_CBC3925586AF1BE8 (member_join_member_modification), PRIMARY KEY(member_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE afamanager_member_modification (member_modification_id INT NOT NULL, member_modification_firstname VARCHAR(255) NOT NULL, member_modification_name VARCHAR(255) NOT NULL, member_modification_photo VARCHAR(255) NOT NULL, member_modification_sex INT NOT NULL, member_modification_address LONGTEXT NOT NULL, member_modification_zip VARCHAR(255) DEFAULT NULL, member_modification_city VARCHAR(255) NOT NULL, member_modification_country VARCHAR(255) NOT NULL, member_modification_email VARCHAR(255) DEFAULT NULL, member_modification_birthday DATE NOT NULL, member_modification_comment LONGTEXT DEFAULT NULL, PRIMARY KEY(member_modification_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('INSERT INTO `afamanager_club` (`club_id`, `club_join_club_last_history`, `club_join_club_main_teacher`, `club_name`, `club_address`, `club_zip`, `club_city`, `club_province`, `club_creation`, `club_type`, `club_bce_number`, `club_iban`, `club_url`, `club_email_public`, `club_president`, `club_treasurer`, `club_secretary`, `club_email_contact`, `club_comment`) VALUES (3037, NULL, NULL, \'Musubi Dojo\', \'30, rue de Ciply\', 7033, \'Cuesmes\', 3, \'2020-05-01\', 2, NULL, NULL, NULL, \'kadrack@hotmail.com\', NULL, NULL, NULL, NULL, NULL)');
        ...
        $this->addSql('INSERT INTO `afamanager_member` (`member_id`, `member_join_member_first_licence`, `member_join_member_last_licence`, `member_join_last_grade_dan`, `member_join_last_kyu`, `member_join_member_modification`, `member_firstname`, `member_name`, `member_photo`, `member_sex`, `member_address`, `member_zip`, `member_city`, `member_country`, `member_email`, `member_birthday`, `member_comment`) VALUES (1, NULL, NULL, NULL, NULL, NULL, \'Frédéric\', \'Buchon\', \'nophoto.png\', 1, \'30\', \'7033\', \'Cuesmes\', \'BE\', \'kadrack@hotmail.com\', \'2020-05-01\', NULL)');
        $this->addSql('INSERT INTO `afamanager_grade_kyu` (`grade_kyu_id`, `grade_kyu_join_member`, `grade_kyu_rank`, `grade_kyu_date`, `grade_kyu_comment`) VALUES (NULL, \'1\', \'1\', \'1991-01-31\', NULL)');
        $this->addSql('INSERT INTO `afamanager_member_licence` (`member_licence_id`, `member_licence_join_grade_kyu`, `member_licence_join_club`, `member_licence_join_member`, `member_licence_update`, `member_licence_deadline`, `member_licence_medical_certificate`, `member_licence_status`) VALUES (1, 1, 3037, 1, \'2020-05-17\', \'1992-01-31\', \'1991-01-31\', 1)');
        $this->addSql('INSERT INTO `afamanager_user` (`id`, `login`, `roles`, `password`, `user_join_member`, `user_join_club`, `user_status`, `user_last_activity`) VALUES (1, \'Test\', \'[\"ROLE_CLUB\", \"ROLE_CFG\", \"ROLE_STAGES\", \"ROLE_SECRETARIAT\"]\', \'$argon2i$v=19$m=65536,t=4,p=1$ZTRTdC4zazFFT0w3aW9XRA$IgtiSPFOv8zJS/8ziH7/TIHXARc7JbKjJ0aUdSJDIV4\', 1, 3037, 1, NULL)');
        $this->addSql('UPDATE `afamanager_member` SET `member_join_member_first_licence` = \'1\', `member_join_member_last_licence` = \'1\', `member_join_last_kyu` = \'1\' WHERE `afamanager_member`.`member_id` = 1');
    }
