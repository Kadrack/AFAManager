...
final class Version20200719164411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE afamanager_grade_title (grade_title_id INT AUTO_INCREMENT NOT NULL, grade_title_join_member INT NOT NULL, grade_title_join_grade_session INT DEFAULT NULL, grade_date DATE DEFAULT NULL, grade_title_rank INT NOT NULL, grade_title_certificate VARCHAR(255) DEFAULT NULL, grade_title_status INT NOT NULL, grade_title_comment LONGTEXT DEFAULT NULL, INDEX IDX_CBDF190D5B3D454E (grade_title_join_member), INDEX IDX_CBDF190DF9F043E9 (grade_title_join_grade_session), PRIMARY KEY(grade_title_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
