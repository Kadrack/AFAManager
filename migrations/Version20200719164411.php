...
final class Version20200719164411 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE afamanager_user (id INT AUTO_INCREMENT NOT NULL, user_join_member INT DEFAULT NULL, user_join_club INT DEFAULT NULL, login VARCHAR(180) NOT NULL, roles VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, user_firstname VARCHAR(255) DEFAULT NULL, user_real_name VARCHAR(255) DEFAULT NULL, user_last_activity DATE DEFAULT NULL, user_status INT NOT NULL, UNIQUE INDEX UNIQ_7B23E8F7AA08CB10 (login), UNIQUE INDEX UNIQ_7B23E8F77111AECB (user_join_member), INDEX IDX_7B23E8F72956F80F (user_join_club), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
